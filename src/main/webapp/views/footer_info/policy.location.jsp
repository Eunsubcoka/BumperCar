...
<div style="padding:30px; background-color:#FFFFFF; font-size:15px; color:#222228;">
            <strong style="font-size:22px;">위치기반서비스 이용약관</strong>

            <div style="margin-top:20px;">
                <strong>시행일자</strong> : <strong id="start-date" style="color:#4a90e2">2024년 06월 12일</strong>

            </div>
            <div class="location-content" style="display:block">
                <br>
<br>
<br>
제 1 조 (목적)<br>
<br>
본 약관은 회원(TastyRoad서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.)이 주식회사 TastyRoad(이하 "회사"라고 합니다.)이 제공하는 TastyRoad(Diningcode) 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
<br>
<br>
제 2 조 (이용약관의 효력 및 변경)<br>
<br>
① 본 약관은 서비스를 신청한 고객 또는 개인위치정보주체가 본 약관에 동의하고 회사가 정한 소정의 절차에 따라 서비스의 회원으로 등록함으로써 효력이 발생합니다.<br>
...
① 서비스명 : TastyRoad<br>
② 서비스내용 : 맛집검색 기능, 위치정보를 이용한 맛집 검색 기능<br>
<br>
<br>
제 5 조 (서비스 이용요금)<br>
<br>
...
② 회원 및 법정대리인의 권리와 그 행사방법은 제소 당시 회원의 주소에 의하며, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 회원의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다.<br>
③ 회사는 회원의 사전 동의 없이 개인위치정보를 제3자에게 제공하지 않으며, 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원에게 제공받는 자, 제공일시 및 제공목적을 즉시 통보합니다. 단, 아래 각 호의 1에 해당하는 경우에는 회원이 미리 특정하여 지정한 통신 단말장치 또는 전자우편주소로 통보합니다.<br>
   1. 개인위치정보를 수집한 당해 통신단말장치가 문자, 음성 또는 영상의 수신기능을 갖추지 아니한 경우<br>
   2. 회원이 온라인 게시 등의 방법으로 통보할 것을 미리 요청한 경우<br>
④ 회사는 위치정보의 보호 및 이용 등에 관한 법률 제16조 제2항에 근거하여 위치정보 수집 ·이용·제공사실 확인자료를 자동으로 기록·보존하며, 해당 자료는 1년간 보관합니다.<br>
<br>
<br>
제 9 조 (개인위치정보의 보유 목적 및 보유 기간)<br>
<br>
회사는 위치기반서비스 제공을 위해 아래와 같이 개인위치정보를 보유합니다.<br>
① 본 약관 제4조에 따른 위치기반서비스 이용 및 제공 목적을 달성한 때에는 지체없이 개인위치정보를 파기합니다.<br>
② 다만, 회원이 작성한 게시물 또는 콘텐츠와 함께 위치정보가 저장되는 서비스의 경우 해당 게시물 또는 콘텐츠 보관기간 동안 개인위치정보가 보관됩니다.<br>
③ 그 외 위치기반서비스 제공을 위해 필요한 경우 이용목적 달성을 위해 필요한 최소한의 기간 동안 개인위치정보를 보유할 수 있습니다.<br>
④ 위 1, 2, 3항에도 불구하고 다른 법령 또는 위치정보법에 따라 보유해야 하는 정당한 사유가 있는 경우에는 그에 따릅니다.<br>
<br>
<br>
제 10 조 (개인위치정보주체의 권리)<br>
<br>
...
<br>
제 11 조 (법정대리인의 권리)<br>
① 회사는 14세 미만의 회원에 대해서는 개인위치정보를 이용한 위치기반서비스 제공 및 개인위치정보의 제3자 제공에 대한 동의를 당해 회원과 당해 회원의 법정대리인으로부터 동의를 받아야 합니다. 이 경우 법정대리인은 제10조에 의한 회원의 권리를 모두 가집니다.<br>
...
<br>
<br>
제 12 조 (8세 이하의 아동 등의 보호의무자의 권리)<br>
① 회사는 아래의 경우에 해당하는 자(이하 "8세 이하의 아동"등이라 한다)의 위치정보의 보호 및 이용 등에 관한 법률 제26조2항에 해당하는 자(이하 "보호의무자")가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보의 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.<br>
   1. 8세 이하의 아동<br>
   2. 피성년후견인<br>
   3. 장애인복지법제2조제2항제2호의 규정에 의한 정신적 장애를 가진 자로서장애인고용촉진및직업재활법 제2조제2호의 규정에 의한 중증장애인에 해당하는 자(장애인복지법 제32조에 따라 장애인등록을 한 자에 한한다)<br>
...
<br>
<br>
제 18 조 (회사의 연락처 사업자 정보 및 위치정보 관리책임자)<br>
   1. 상 호 : 주식회사 TastyRoad<br>
   2. 주 소 : 경기도 안양시 만안구 안양로 303 메쎄포스빌타워 8층 <br>
   3. 대표전화 : 031-1234-5678<br>
   4. 위치정보 관리책임자 : 이은섭 CTO<br>
<br>
<br>
부 칙<br>
<br>
제1조 (시행일)<br>
 본 약관은 2024년 06월 12일부터 적용됩니다.            </div>
