...
<body>
    ...
    <main class="reservation-main">
        ...
        <div class="reservation-list">
            ...
            <div class="reservation-items" onclick="openPopup(${reservation.resNo}, '${reservation.restaurantName}', '${reservation.date}', ${reservation.headCount}, '${reservation.paymentStatus}')">
    ...
    <script>
        function openPopup(resNo, restaurantName, date, headCount, paymentStatus) {
