    ...
    <section>
        <div class="profile-form">
            ...
            <form action="/profile.do" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <span id="userEmail-msg" class="error-msg"></span>
                
                <label for="userAddress">주소:</label>
                <input type="text" id="new-address" name="new-address" value="${member.userAddress}" required>
                ...
                <span id="userAddress-msg" class="error-msg"></span>
                
                <label for="userPhone">전화번호:</label>
                <input type="text" id="userPhone" name="userPhone" value="${member.userPhone}">
                <span id="userPhone-msg" class="error-msg"></span>
